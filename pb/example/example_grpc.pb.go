...
func (c *exampleClient) SayHello(ctx context.Context, in *SayHelloRequest, opts ...grpc.CallOption) (*SayHelloResponse, error) {
...
func (UnimplementedExampleServer) SayHello(context.Context, *SayHelloRequest) (*SayHelloResponse, error) {
...
func _Example_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ExampleServer).SayHello(ctx, req.(*SayHelloRequest))
	}
